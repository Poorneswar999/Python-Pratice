...
Input Format: Line 1: Item Name (String). Line 2: Quantity (Integer). Line 3: Unit Price (Float). Output Format: Two lines; the first line showing 'Item: ' followed by the name, and the second line showing 'Total: ' followed by the calculated value.
'''
